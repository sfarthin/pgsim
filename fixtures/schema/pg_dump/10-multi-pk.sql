...
ALTER TABLE ONLY "public"."ccc"
    ADD CONSTRAINT "ccc_pkey" PRIMARY KEY ("a", "b");


--
-- Name: xyz; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "xyz" ON "public"."ccc" USING "btree" ("b");


--
-- Name: ccc ccc_a_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."ccc"
    ADD CONSTRAINT "ccc_a_fkey" FOREIGN KEY ("a") REFERENCES "public"."aaa"("id");


--
-- Name: ccc ccc_b_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."ccc"
    ADD CONSTRAINT "ccc_b_fkey" FOREIGN KEY ("b") REFERENCES "public"."bbb"("id");
