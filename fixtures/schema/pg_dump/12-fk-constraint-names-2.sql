...
--
-- Name: name1; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "name1" ON "public"."bbb" USING "btree" ("a");


--
-- Name: bbb name2; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."bbb"
    ADD CONSTRAINT "name2" FOREIGN KEY ("a") REFERENCES "public"."aaa"("id");
