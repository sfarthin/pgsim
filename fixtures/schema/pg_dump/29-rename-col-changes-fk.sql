...
ALTER TABLE ONLY "public"."aaa"
    ADD CONSTRAINT "aaa_pkey" PRIMARY KEY ("a_id");


--
-- Name: bbb foo; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."bbb"
    ADD CONSTRAINT "foo" FOREIGN KEY ("a") REFERENCES "public"."aaa"("a_id");
