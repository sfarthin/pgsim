-- @error-statement { "token": "SELECT", "expected": ["!","!=","#","%","&","*","+",",","-","/","::",";","<","<<","<=","<>","=",">",">=",">>","AND","AS","End of Input","FROM","GROUP","IN","IS","OR","ORDER","^","identifier","in","|","||"] }
SELECT 1
SELECT 2
